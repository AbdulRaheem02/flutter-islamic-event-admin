          ...
          children: [
            Obx(() => Expanded(
                  child: ListView.builder(
                      ...
                      itemCount:
                          _initialStatusController.allnotificationlist.length,
                      itemBuilder: (context, index) {
                        NotificationModel notificationdetail =
                            _initialStatusController.allnotificationlist[index];
                            ...
                            : GestureDetector(
                                onTap: () {
                                  if (notificationdetail.type == "book") {
                                    ...
                                    Get.find<InitialStatusController>()
                                        .getProjectById(
                                            projectId: notificationdetail.id)
                                        .then((value) async {
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      border:
                                          Border.all(color: appTheme.gray400),
                                      borderRadius:
