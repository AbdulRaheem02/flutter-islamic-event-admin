...
import '../donation_payment_screen/donation_payment_screen.dart'; // ignore_for_file: must_be_immutable

// ignore_for_file: must_be_immutable
class EventPaymentScreen extends StatelessWidget {
  EventPaymentScreen({super.key});
                        ...
                        Row(
                          children: [
                            SizedBox(
                              width: 280.v,
                              child: Text(
                                "Please add your number and submit to proceed your request.",
                                style: TextStyle(
                                  letterSpacing: 0.5.h,
                                  fontSize: 12.v,
                                  fontFamily: "Poppins",
